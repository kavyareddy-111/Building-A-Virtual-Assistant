...
def virtual_assistant(data):
    ...
    if "email" in data:
        ...
        to = listen()
        edict = {'hello':'sankichinnu@gmail.com','new':'nikhila2410@gmail.com'} #give mail ids
        toaddr = edict[to]
        ...
        mail.starttls()
        #login
        mail.login('sankichinnu2004@gmail.com','sbijvkpmdfzzgigb') #enter mailid and app password make sure you enable less secure app access
        mail.sendmail('sankichinnu2004@gmail.com',toaddr,content) #enter your gmail username
        mail.close()
        respond('Email Sent')
...
respond("Hey Saankitha Varma how are you")
listening = True
